...
public class FideChallenge extends Boss {

    private long st;

    public FideChallenge() throws Exception {
        super(BossID.FIDE_CHALLENGE, BossesData.FIDE_CHALLENGE);
    }
    ...
    public void die(Player plKill) {
        if (plKill != null) {
            ...
            try {
                ...
                utils.Logger.logException(FideChallenge.class, e); 
            } finally {
