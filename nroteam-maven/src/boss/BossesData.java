...
public class BossesData {
    ...
    private static final int REST_1000_M = 259200000;
    ...
    public static final BossData TIEU_DOI_TRUONG_NM = new BossData(
            ...
            REST_10_M,
            new int[]{BossID.SO_2_NM, BossID.SO_1_NM, BossID.SO_3_NM, BossID.SO_4_NM,} //type appear
    );
...
//**************************************************************************
    ...
    public static final BossData CADIC_12H = new BossData(
            "Ca Đít", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static final BossData DRABURA_2 = new BossData(
            ...
            REST_5_M,
            new int[]{BossID.GOKU, BossID.CADIC_12H}
    );
    ...
    public static final BossData THO_DAI_CA = new BossData(
            "Thỏ Đại Ca", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{403, 404, 405, -1, -1, -1}, // placeholder outfit
            10000, //dame
            new long[]{1_000_000}, //hp
            new int[]{19, 20, 37},
            new int[][]{{skill.Skill.DRAGON, 7, 1000}},
            new String[]{"|-1|Cà rốt đâu, đưa hết đây!"},
            new String[]{},
            new String[]{},
            REST_15_M
    );
    ...
    public static final BossData KARIN = new BossData(
            ...
            100, //dame
            new long[]{500}, //hp
            new int[]{46}, //map join (safe home map)
            new int[][]{
                {Skill.GALICK, 1, 1000},
                {Skill.TAI_TAO_NANG_LUONG, 1, 60000},},
            new String[]{"|-1|Ta sẽ dạy ngươi vài chiêu",
    ...
    //========================THIÊN TỬ======================== 
    public static final BossData MAROON = new BossData(
            "Maroon",
            ConstPlayer.TRAI_DAT,
            new short[]{1140, 1141, 1142, -1, 246, -1},
            50000,
            new long[]{500000000},
            new int[]{190, 191},
            new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
                {Skill.TAI_TAO_NANG_LUONG, 7, 10000},
                {Skill.ANTOMIC, 7, 8000},
                {Skill.MASENKO, 7, 6000}
            },
            new String[]{
                "|-1|Hahaha, yếu đuối!",
                "|-3|Chịu chết đi!",
                "|-4|Ngươi không phải đối thủ của ta!",
                "|-5|Sức mạnh này... Ngươi cảm nhận được không?",
                "|-6|Kết thúc rồi!"
            },
            new String[]{
                "|-1|Cũng khá đấy!",
                "|-3|Grừừừ... Đau đấy!",
                "|-4|Chỉ có vậy thôi sao?",
    ...
    public static final BossData PIKACHU = new BossData(
            "Pikachu",
            ConstPlayer.TRAI_DAT,
            new short[]{1763, 1764, 1765, -1, -1, -1},
            50000,
            new long[]{500000},
            new int[]{0},
            new int[][]{
    ...
    public static final BossData CHARMENDER = new BossData(
            "Charderman",
            ConstPlayer.TRAI_DAT,
            new short[]{1766, 1767, 1768, -1, -1, -1},
            50000,
            new long[]{500000},
            new int[]{1, 7, 14, 24, 25, 26},
            new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
                {Skill.TAI_TAO_NANG_LUONG, 7, 10000},
                {Skill.ANTOMIC, 7, 8000},
    ...
    public static final BossData BULLBASAUR = new BossData(
            "Bullbasaur",
            ConstPlayer.TRAI_DAT,
            new short[]{1772, 1773, 1774, -1, -1, -1},
            50000,
            new long[]{500000},
            new int[]{1, 7, 14, 24, 25, 26},
            new int[][]{
    ...
    public static final BossData SQUIRTLE = new BossData(
            "Squirtle",
            ConstPlayer.TRAI_DAT,
            new short[]{1769, 1770, 1771, -1, 246, -1},
            50000,
            new long[]{500000},
            new int[]{1, 7, 14, 24, 25, 26},
            new int[][]{
    ...
    public static final BossData KOROCHI = new BossData(
            "Korochi",
            ConstPlayer.TRAI_DAT,
            new short[]{1784, 1785, 1786, -1, -1, -1},
            20000,
            new long[]{100000000},
            new int[]{92, 93, 24, 25, 26},
            new int[][]{
                {Skill.DRAGON, 7, 5000},
            ...
            new String[]{
                "|-1|Nếu các ngươi đã thành tâm muốn biết.",
                "|0|Thì bọn ta sẵn lòng trả lời!",
                "|-1|Để đề phòng thế giới bị phá hoại!",
                "|0|Để bảo vệ nền hòa bình thế giới!",
                "|-1|Bọn ta đại diện cho những nhân vật phản diện...",
                "|0|...đầy khả ái và ngây ngất lòng người!",
                "|-1|Musashi!",
                "|0|Kojiro!",
                "|-1|Băng Hỏa Tiễn, bảo vệ dải ngân hà!",
                "|0|Một tương lai tươi sáng đang chờ đợi bọn ta!",
                "|1|Chuyện là thế đấy! Meowth!"
            }, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            REST_1_S,
            new int[]{BossID.MUSHASHI, BossID.MEOWTH}
    );

    public static final BossData MUSHASHI = new BossData(
            "Mushashi",
            ConstPlayer.TRAI_DAT,
            new short[]{1778, 1779, 1780, -1, -1, -1},
            20000,
            new long[]{100000000},
            new int[]{92, 93, 24, 25, 26},
            new int[][]{
    ...
    public static final BossData MEOWTH = new BossData(
            "Meowth",
            ConstPlayer.TRAI_DAT,
            new short[]{1781, 1782, 1783, -1, -1, -1},
            20000,
            new long[]{100000000},
            new int[]{92, 93, 24, 25, 26},
            new int[][]{
    ...
    public static final BossData XEN_BO_HUNG_4 = new BossData(
            "Xên hoàn thiện",
            ConstPlayer.XAYDA,
            new short[]{234, 235, 236, -1, -1, -1},
            30000,
    ...
    public static final BossData FIDE_CHALLENGE = new BossData(
            "Fide Đại Ca", //name
            ConstPlayer.XAYDA, //gender
            new short[]{189, 190, 191, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            30000, //dame
    ...
    public static final BossData MABU_CHALLENGE = new BossData(
            "Ma bư",
            ConstPlayer.XAYDA,
            new short[]{297, 298, 299, -1, -1, -1},
            500000,
    ...
    public static final BossData CHILL_1 = new BossData(
            "Chill",
            ConstPlayer.TRAI_DAT,
            new short[]{1024, 1025, 1026, -1, -1, -1},
            20000,
            new long[]{1_000_000_000},
            new int[]{163},
            new int[][]{
            ...
            // ======== CHAT PHASES ========
            new String[]{"|-1|Hahaha... Ta đến để hủy diệt tất cả!"}, // text chat 1 (trước khi đánh)
            new String[]{"|0|Ta chính là đệ nhất vũ trụ cao thủ!"},
            new String[]{"|-1|Ác quỷ biến hình aaa..."},
            REST_30_M
    );
    ...
    public static final BossData CHILL_2 = new BossData(
            "Chill 2",
            ConstPlayer.TRAI_DAT,
            new short[]{1021, 1022, 1023, -1, -1, -1},
            20000,
            new long[]{2_000_000_000},
            new int[]{163},
            new int[][]{
            ...
            // ======== CHAT PHASES ========
            new String[]{"|-1|Hahaha... Không ai có thể đánh bại ta!"},
            new String[]{"|0|Ta đã giấu hết ngọc rồng rồi, các ngươi tìm vô ích hahaha"},
            new String[]{"|-1|Không thể nào... ta thua ư..."},
            AppearType.APPEAR_WITH_ANOTHER
    );

    public static final BossData CUMBER_1 = new BossData(
            "Cumber", //name
            ConstPlayer.XAYDA, //gender
            ...
            new String[]{"|-1|Ta sẽ tàn sát khu này trong vòng 5 phút nữa",
                "|-1|Haha, mày đây rồi",
                "|-1|Tao đã có lệnh của đại ca rồi",
                "|-1|Tao hơn hẳn mày, nhìn máy đo đi",
                "|-1|Mày yếu đi đó, với sức chiến đấu đó sao có thể thắng được tao",
                "|-1|Định chạy trốn hả, hử"
            }, //text chat 2
    ...
    public static final BossData BABY = new BossData(
            "Baby",
            ConstPlayer.XAYDA,
            new short[]{1656, 1657, 1658, -1, -1, -1},
            200000,
            new long[]{2000000000},
            new int[]{166},
            new int[][]{
                ...
                {Skill.SUPER_KAME, 1, 10000}},//skill
            new String[]{}, //text chat 1
            new String[]{"|-2|Hắn làm ta bất ngờ đấy! Khốn kiếp!",
    ...
    public static final BossData BABY_2 = new BossData(
            "Baby",
            ConstPlayer.XAYDA,
            new short[]{1659, 1660, 1661, -1, -1, -1},
            250000,
            ...
            new int[][]{
                ...
                {Skill.KHIEN_NANG_LUONG, 1, 10000},
                {Skill.LIEN_HOAN, 7, 10000},
                {Skill.SUPER_KAME, 1, 20000}},//skill
            new String[]{}, //text chat 1
            new String[]{"|-2|Nguy rồi... thực sự nguy to rồi!",
                "|-1|Các ngươi nghĩ có thể chạy được sao!?",
                "|-1|Muốn chạy khỏi ta thì đừng hòng!!",
