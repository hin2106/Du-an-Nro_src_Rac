...
public class NADIC extends Boss {
    ...
    public void leaveMap() {
        ...
        if (this.clan != null && this.clan.ConDuongRanDoc != null && this.isDie()) {
            for (Boss b : this.clan.ConDuongRanDoc.bosses) {
                if (b.id == BossID.CADICH && b.bossStatus == BossStatus.AFK) {
                    // Let Cađích start with chat as designed
                    b.changeStatus(BossStatus.CHAT_S);
                    break;
                }
            }
        }
