...
import utils.Logger;
import utils.Util;
import services.events.HalloweenMenuHook;

public abstract class Npc implements IAtionNpc {

    public static final int MENU_CANDY_PROMPT = 9096;
    ...
    public void createOtherMenu(Player player, int indexMenu, String npcSay, String... menuSelect) {
        ...
        try {
            if (player != null && player.idMark != null) {
                ...
                utils.Logger.logln("Npc.createOtherMenu - player or idMark is null");
            }
            msg = new Message(32);
            ...
            utils.Logger.logException(Npc.class, e, "Error in createOtherMenu");
            e.printStackTrace();
        }
    }
    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            try {
                if (HalloweenMenuHook.interceptOpenNpc(player, this)) {
                    return;
                }
