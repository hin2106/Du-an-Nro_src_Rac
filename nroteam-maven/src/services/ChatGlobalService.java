...
public class ChatGlobalService implements Runnable {
    ...
    private final Queue<ChatGlobal> waitingChat ;
    ...
    public void chatBot(Player player, String text) {
    ...
    public void run() {
        while (!Maintenance.isRunning()) {
            try {
                ...
                ChatGlobal chat = waitingChat.poll();
                if (chat != null && listChatting.size() < COUNT_CHAT) {
