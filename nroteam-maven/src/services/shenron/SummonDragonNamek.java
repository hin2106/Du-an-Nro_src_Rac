...
public class SummonDragonNamek {
    ...
    public void summonNamec(Player pl) {
        if (pl.zone != null && pl.zone.map != null && pl.zone.map.mapId == 7) {
                                ...
                                playerSummonShenron.clan.members.forEach(m -> {
                                    if (Client.gI().getPlayer(m.id) != null) {
                                        ...
                                        try {
                                            ...
                                            Logger.getLogger(SummonDragonNamek.class.getName()).log(Level.SEVERE, null, ex);
                                        }
                                    }
                                });
                            } else {
    ...
    public void shenronLeave(Player pl, byte type) {
        ...
        activeShenron(pl, false, SummonDragonNamek.DRAGON_PORUNGA);
