...
public class Clan {
    ...
    public long thoiGianHoanThanhConDuongRanDoc;
    public int levelDoneConDuongRanDoc;
    public int timesPerDayCDRD;
    ...
    public long thoiGianHoanThanhKhiGaHuyDiet;
    public int levelDoneKhiGaHuyDiet;

    public BossChallenge bossChallenge;
    public long lastTimeBossChallenge;
    public Player playerOpenBossChallenge;
    public int bossChallengeToday;
    public long lastBossChallenge;
    ...
    public void addSMTNClan(Player plOri, long param) {
        for (int i = this.membersInGame.size() - 1; i >= 0; i--) {
            ...
            if (pl != null && !plOri.equals(pl) && pl.zone != null && plOri.zone.equals(pl.zone)) {
                int levelOri = Service.gI().getCurrLevel(plOri);
                int levelTarget = Service.gI().getCurrLevel(pl);
                int levelDiff = Math.abs(levelTarget - levelOri);
    ...
    public Player getPlayerOnline(int playerId) throws Exception {
    ...
    public void insert() {
        ...
        for (ClanMember cm : this.members) {
            ...
            dataObject.put("attendance_time", cm.attendanceTime);
        ...
        String topBanDoKhoBau = "[" + levelDoneBanDoKhoBau + "," + thoiGianHoanThanhBDKB + "," + System.currentTimeMillis() + "]";
        String topKhiGaHuyDiet = "[" + levelDoneKhiGaHuyDiet + "," + thoiGianHoanThanhKhiGaHuyDiet + "," + System.currentTimeMillis() + "]";
        String topConDuongRanDoc = "[" + levelDoneConDuongRanDoc + "," + thoiGianHoanThanhConDuongRanDoc + "," + System.currentTimeMillis() + "]";
        ...
        try (Connection con = AlyraManager.getConnection();) {
            ps = con.prepareStatement("insert into clan (id, name, name_2, slogan, img_id, power_point, max_member, clan_point, level, thanhtichbdkb, thanhtichkghd, thanhtichcdrd, thongtin, members) "
                    + "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ps.setInt(1, this.id);
            ...
            ps.setString(11, topKhiGaHuyDiet);
            ps.setString(12, topConDuongRanDoc);
            ps.setString(13, thongTinLeader);
            ps.setString(14, member);
            ps.executeUpdate();
            ps.close();
        } catch (Exception e) {
    ...
    public void update() {
        ...
        try (Connection con = AlyraManager.getConnection();) {
            ...
            ps.setString(13, "[" + this.bossChallengeToday + "," + this.lastBossChallenge + "]");
    ...
    public void updatethanhTichBDKB(int clanId) {
        String topBanDoKhoBau = "[" + levelDoneBanDoKhoBau + "," + thoiGianHoanThanhBDKB + "," + System.currentTimeMillis() + "]";
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update clan set thanhtichbdkb = ? where id = ? limit 1")) {
    ...
    public void updatethanhTichKGHD(int clanId) {
        String topKhiGaHuyDiet = "[" + levelDoneKhiGaHuyDiet + "," + thoiGianHoanThanhKhiGaHuyDiet + "," + System.currentTimeMillis() + "]";
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update clan set thanhtichkghd = ? where id = ? limit 1")) {
            ps.setString(1, topKhiGaHuyDiet);
            ps.setInt(2, clanId);
            ps.executeUpdate();
        } catch (Exception e) {
        }
    ...
    public void updatethanhTichCDRD(int clanId) {
        String topConDuongRanDoc = "[" + levelDoneConDuongRanDoc + "," + thoiGianHoanThanhConDuongRanDoc + "," + System.currentTimeMillis() + "]";
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update clan set thanhtichcdrd = ? where id = ? limit 1")) {
    ...
    public void updatethanhTichBDKBForLeader() {
        ...
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update player set thanhtichbdkb = ? where id = ? limit 1")) {
            ps.setString(1, topBanDoKhoBau);
    ...
    public void updatethanhTichKGHDForLeader() {
        String topKhiGaHuyDiet = "[" + this.name + "," + this.levelDoneKhiGaHuyDiet + "," + thoiGianHoanThanhKhiGaHuyDiet + "," + System.currentTimeMillis() + "]";
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update player set thanhtichkghd = ? where id = ? limit 1")) {
            ps.setString(1, topKhiGaHuyDiet);
            ps.setInt(2, this.getLeader().id);
            ps.executeUpdate();
        } catch (Exception e) {
    ...
    public void updatethanhTichCDRDForLeader() {
        String topConDuongRanDoc = "[" + this.name + "," + this.levelDoneConDuongRanDoc + "," + thoiGianHoanThanhConDuongRanDoc + "," + System.currentTimeMillis() + "]";
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update player set thanhtichcdrd = ? where id = ? limit 1")) {
            ps.setString(1, topConDuongRanDoc);
            ps.setInt(2, this.getLeader().id);
            ps.executeUpdate();
        } catch (Exception e) {
    ...
    public void updateThongTinLeader(int clanId) {
        String thongTinLeader = "[" + getLeader().id + "," + getLeader().name + "," + getLeader().head + "," + getLeader().body + "," + getLeader().leg + "]";
        try (Connection con = AlyraManager.getConnection(); PreparedStatement ps = con.prepareStatement("update clan set thongtin = ? where id = ? limit 1")) {
