...
public class ItemMap {
    ...
    public boolean playerOriginDrop;
    public String auditTraceId;
    public long originalDropperId = -1;
    public long auditItemCreateTime;
    ...
    public ItemMap(ItemMap itemMap) {
        ...
        this.playerOriginDrop = itemMap.playerOriginDrop;
        this.auditTraceId = itemMap.auditTraceId;
        this.originalDropperId = itemMap.originalDropperId;
        this.auditItemCreateTime = itemMap.auditItemCreateTime;
    ...
    public void update() {
        if (isNotNullItem()) {
            ...
            if (Util.canDoWithTime(createTime, 45000)) {
                if (this.itemTemplate.type != 22 && this.itemTemplate.id != 726 && this.itemTemplate.id != 992 && this.itemTemplate.id != 78) {
                    this.playerId = -1;
                }
            }
