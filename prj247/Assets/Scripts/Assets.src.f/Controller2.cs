                    ...
                    case 42:
                        {
                            ...
                            if (haveName == 1)
                            {
                                ...
                                {
                                    GameCanvas.registerScr.onRegisterSuccess();
                                }
                                else
                                {
                    ...
                    case 125:
                        {
                            ...
                            Char fusionChar = ((num16 == Char.myCharz().charID) ? Char.myCharz() : GameScr.findCharInMap(num16));
                            if (fusionChar != null)
                            {
                                if (msg.reader().available() >= 6)
                                {
                                    fusionChar.head = msg.reader().readShort();
                                    fusionChar.body = msg.reader().readShort();
                                    fusionChar.leg = msg.reader().readShort();
                                }
                                fusionChar.setFusion(fusion);
                            }
                            break;
                        }
                    case 124:
                    ...
                    case -102:
                        {
                            ...
                            if (b11 != 0 && b11 == 1)
                            {
                                ...
                                string acc = !string.IsNullOrEmpty(GameCanvas.acc) ? GameCanvas.acc : Rms.loadRMSString("acc");
                                string pass = !string.IsNullOrEmpty(GameCanvas.pass) ? GameCanvas.pass : Rms.loadRMSString("pass");
                    ...
                    case -101:
                        {
                            ...
                            string trialPassword = msg.reader().readUTF();
                            Rms.saveRMSString("userAo" + ServerListScreen.ipSelect, text);
                            Rms.saveRMSString("passAo" + ServerListScreen.ipSelect, trialPassword);
