...
public class ServerListScreen : mScreen, IActionListener
{
    ...
    public static string ListIP = "NRO Luna:127.0.0.1:14445:0,0,0";
    ...
    private void initCommand()
    {
        ...
        Rms.saveRMSString("userAo" + ipSelect, string.Empty);
        Rms.saveRMSString("passAo" + ipSelect, string.Empty);
    ...
    public override void paint(mGraphics g)
    {
        ...
        int num2 = 2;
        mFont.tahoma_7_white.drawStringBorder(g, "v" + GameMidlet.VERSION + " (x" + mGraphics.assetZoomLevel + " HD)", GameCanvas.w - 2, num2 + 20, 1, mFont.tahoma_7_grey);
    ...
    private void openRegisterScreen()
    {
        ...
        Rms.saveRMSString("passAo" + ipSelect, string.Empty);
        LoginScr.serverName = nameServer[ipSelect];
        RegisterScreen.serverName = nameServer[ipSelect];
            ...
            case 3:
                {
                    ...
                    bool hasAccount = !string.IsNullOrEmpty(Rms.loadRMSString("acc"));
                    if (!hasAccount)
                    {
                        openRegisterScreen();
                    }
