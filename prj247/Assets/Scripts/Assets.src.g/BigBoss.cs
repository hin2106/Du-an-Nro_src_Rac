...
namespace Assets.src.g
{
    public class BigBoss : Mob, IMapObject
    {
        ...
        public void getDataB2()
        {
            data = null;
            data = new EffectData();
            string patch = "/x" + mGraphics.assetZoomLevel + "/effectdata/" + 100 + "/data";
            try
            {
        ...
        public void getDataB()
        {
            data = null;
            data = new EffectData();
            string patch = "/x" + mGraphics.assetZoomLevel + "/effectdata/" + 101 + "/data";
            try
            {
                data.readData2(patch);
        ...
        public override void paint(mGraphics g)
        {
            ...
            paintRoundedHpBar(g, num3, num4, imageWidth * 2, imageHeight, num5, num5);
            if (shock)
            {
                tShock++;
