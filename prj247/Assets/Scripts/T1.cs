public class T1 : mResources
{
    public static void load()
    {
        ...
        mResources.notiRuby = "Khi bán thành công sẽ nhận lại Ngọc, bạn có muốn tiếp tục kí gửi?";
        mResources.notiThoivang = "Khi bán thành công sẽ nhận lại Thỏi Vàng";
        ...
        mResources.potential_to_learn = "tiềm năng gặp Quy lão Kame để học";
