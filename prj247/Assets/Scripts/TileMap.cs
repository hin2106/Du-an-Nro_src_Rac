...
public class TileMap
{
    ...
    public static MyVector vEffect = new MyVector();
    ...
    public static void loadBg()
    {
        ...
        if (mGraphics.assetZoomLevel != 1 && !Main.isIpod && !Main.isIphone4)
        {
    ...
    public static void getTile()
    {
        ...
        if (image != null)
        {
            Rms.DeleteStorage("x" + mGraphics.assetZoomLevel + "t" + tileID);
            imgTile = new Image[100];
